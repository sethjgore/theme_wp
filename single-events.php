...
<?php endif; ?>
    ...
    <div class="type-size-subtitle white line-height-2 type-name-serif"><?php $location = get_field('location'); print_r($location) if($location){ echo $location['address'];} ?></div>
</div>
