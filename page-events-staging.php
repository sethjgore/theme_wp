<?php
 /* Template Name: Event List Staging */
...
<div class="type-size-two" style="background: url(https://thumbs.dreamstime.com/b/free-hand-sketch-new-york-city-skyline-vector-scribble-outline-67170900.jpg) center center;
    background-size: 120%; height: 3em;"></div>
            <div class="px2 pb2 py1 flex flex-column items-center justify-center width-full">
                <form action="https://deafnyc.us6.list-manage.com/subscribe/post?u=1abda531ae2441b963c08078f&amp;id=66fbf5b4ce" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate flex flex-column items-center" target="_blank" novalidate>
            ...
            <div class="button-pill overflow-hidden flex mt1 mb3"><input type="email" value="" name="EMAIL" id="mce-EMAIL" class="button bg-blue-royal white px2 inline flex type-size-subtitle py1">
            <input class="inline button type-name-sans type-size-subtitle py1 px3 bg-orange white" type="submit" text="Add me to the list!" name="subscribe" value="Subscribe">
