...
module.export({FilesCollection:function(){return FilesCollection}});var Cookies;module.import('meteor/ostrio:cookies',{"Cookies":function(v){Cookies=v}});
var EventEmitter, FileCursor, FilesCursor, NOOP, Throttle, bound, events, fileType, _fixJSONParse, _fixJSONStringify, formatFleURL, fs, nodePath, request, writeStream;
                                                                                                                       //
NOOP = function NOOP() {};                                                                                             //
                                                                                                                       //
if (Meteor.isServer) {                                                                                                 //
