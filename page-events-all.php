  ...
  <?php while( $teachers->have_posts() ) : $teachers->the_post(); ?>
    ...
    while ( have_rows('cycle_events') ) : the_row();
      ...
      ?>
          ...
          <a href="<?php $event->the_permalink() ?>" class="p2 bg-white text-decoration-none items-center mb2 width-full flex"><div><div class="type-size-subtitle line-height-1 m1 type-name-serif green-1 bold line-height-2"><?php echo $event->title; ?> </div></div>
